...
const ProfileIcon: FC<IconProps> = ({ color }) => (
  <svg width="30" height="30" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M23.5 19.5V18.404C23.5 17.023 22.381 15.904 21 15.904H20.199" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M1.5 19.5V18.404C1.5 17.023 2.619 15.904 4 15.904H4.801" stroke={color} stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M17.8389 19.5V17.899C17.8389 15.966 16.2719 14.399 14.3389 14.399H10.6599C8.72691 14.399 7.15991 15.966 7.15991 17.899V19.5" stroke={color} stroke-width="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
